...
const TABS = [
  {
    ...
    label: 'Übersicht',
    icon: (active: boolean) => (
      <svg viewBox="0 0 24 24" width="25" height="25" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    icon: (active: boolean) => (
      <svg viewBox="0 0 24 24" width="25" height="25" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r={active ? 3.4 : 3} fill={active ? 'currentColor' : 'none'} />
